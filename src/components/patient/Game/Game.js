...
//             <div className="time">
//               <p name="time"
//                  onChange={this.handleChange}>{`Time: ${this.time}s`}</p>
//               <p name="accuracy"
//                  onChange={this.handleChange}>{`Accuracy: ${this.accuracy}%`}</p>
//             </div>
//           </div>
//           <div className="field">
//             {this.renderdots()}
...
//         //check for overlap
//         if (Math.abs(y - this.valY[z]) < 40 && Math.abs(x - this.valX[z])
//             < 40) {
//           overlap = true;
//           break;
//         }
...
//         (this.total - this.mistakes) / this.total).toPrecision(2) * 100;
